      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <button class="btn btn-info" style="margin-top:-10px; margin-left: 20px;">
            <!-- <a href="adCAddInfo.html"></a>  -->
          ＋添加机构</button>
        </div>
          <div class="row col-xs-8 addInfo"  >
          ...
          <div class="row" >
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <a class="box-title" href="adCInfoDescription.html">
                  花花大学</a>
              </div>
              <div class="box-body">
                <p>一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢一段描述噢噢噢噢噢噢噢 </p>
              </div>
              <!-- 新加的按钮 -->
              <div class="infoList">
                <button class="btn btn-danger" data-toggle="modal" data-target="#myModal-del">删除</button>
                <button class="btn btn-warning">
                  <!-- <a href="adCInfoDesChange.html"></a> -->
                  修改</button>
...
<li class="col-md-6 col-xs-6" style="float: left;">
  <div class="box box-default">
    ...
    <div class="box-body" >
      <p>一段描述噢噢噢噢噢噢噢 一段描述噢噢噢噢噢噢噢 一段描述噢噢噢噢噢噢噢 一段描述噢噢噢噢噢噢噢 </p>
    </div>
    <!-- 新加的按钮 -->
    <div class="infoList">
      <button class="btn btn-danger" data-toggle="modal" data-target="#myModal-del">删除</button>
