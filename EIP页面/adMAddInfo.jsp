        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="adMInfo.html"><i class="fa fa-circle-o"></i> 初&nbsp;&nbsp;中</a></li>
              <li><a href="adHInfo.html"><i class="fa fa-circle-o"></i> 高&nbsp;&nbsp;中</a></li>
          ...
          <div class="row" >
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title" href="infoDescription.html">初中</h3>
              </div>
              <div class="box-body">
                <div class="box-body " id="inputchoose" >
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">初中名称</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">教职工数量</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">专职老师数量</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">学生总人数</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">年招生人数</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">初中描述</label>
                        <div class="col-sm-5">
                            <textarea class="form-control" rows="4" placeholder="请输入相关描述" style="resize: none;"></textarea>
                        </div>
                      </div>
                      <!-- 隐藏 -->
                      <div class="form-group" hidden>
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="幼稚园" >初中
                        </div>
                      </div>
                      <div class="form-group" hidden>
                        <label for="inputPassword" class="col-sm-2 control-label">点坐标X</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <div class="form-group" hidden>
                        <label for="inputPassword" class="col-sm-2 control-label">点坐标Y</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                        </div>
                      </div>
                      <!-- 隐藏结束 -->
                      <div class="form-group">
                         <button type="button" class="btn btn-info col-xs-offset-2" style="margin-top: 20px;">
                          <!-- <a href="adHInfo.html"></a> -->
                        提交</button>
                          <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 20px;">
                           <!-- <a href="adHInfo.html">返回</a>  -->
                           返回</button>
