      ...
      <div class="row" style="min-height: 500px;">
        <div class="col-xs-12">
          <div class="box">
            ...
            <ul class="miaoShu">
              <li class="col-xs-12">
                  <h3 >用户名</h3> <span><strong><i> 鹿柴呀</i></strong> </span>
              </li>
              <li class="col-xs-12">
                  <h3>邮箱</h3> <span><strong><i>810122753@qq.com</i></strong> </span>
              </li>
              <li class="col-xs-12">
                  <h3>手机号</h3> <span><strong><i>12283859121</i></strong></span>
              </li>
              <li class="col-xs-12">
                  <h3>密保问题</h3> <span><strong><i>balbalabla</i></strong></span>
              </li>
              <li class="col-xs-12">
                  <h3>密保答案</h3> <span><strong><i>111111</i></strong></span>
              </li>
              <li class="col-xs-12">
                  <h3>角色</h3> <span><strong><i>用户</i></strong></span>
              </li>
                <div class="form-group">
                   <button type="button" class="btn btn-info col-xs-offset-1" >
