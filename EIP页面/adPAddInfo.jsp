        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="adPInfo.html"><i class="fa fa-circle-o"></i> 小&nbsp;&nbsp;学</a></li>
          ...
          <div class="row" >
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title" href="infoDescription.html">小学</h3>
              </div>
              <div class="box-body">
                <div class="box-body " id="inputchoose" >
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">小学名称</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">小学描述</label>
                        <div class="col-sm-5">
                      ...
                      <div class="form-group" hidden>
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputPassword" placeholder="幼稚园" >小学
                        </div>
                      </div>
                      <div class="form-group" hidden>
