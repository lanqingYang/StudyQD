            ...
            <li class="active treeview menu-open">
              <a href="#">
               ...
               <ul class="treeview-menu">
                ...
                <li class="active"><a href="cInfo.html"><i class="fa fa-circle-o"></i> 大&nbsp;&nbsp;学</a></li>
              </ul>
            </li>
      ...
      <div class="row" >
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <a class="box-title" href="cInfoDescription.html">
              花花大学</a>
          </div>
          <div class="box-body">
            <p>一段描述噢噢噢噢噢噢噢 </p>
          ...
          <div style="text-align: right;">
            <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:10px;">
              <!-- <a href="cInfoDescription.html" style="color: white; "></a> -->
              查看</button>
          </div>
...
<!-- 第一个框结束 -->
 ...
 <li class="col-md-6 col-xs-6" style="float: left;">
  <div class="box box-default">
    <div class="box-header with-border">
      <a class="box-title" href="cInfoDescription.html">花花幼儿园</a>
    </div>
    <div class="box-body">
      <p>一段描述噢噢噢噢噢噢噢 </p>
    </div>
