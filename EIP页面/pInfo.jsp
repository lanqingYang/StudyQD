      ...
      <div class="row" >
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <a class="box-title" href="pInfoDescription.html">
              花花小学</a>
          </div>
          <div class="box-body">
            <p>一段描述噢噢噢噢噢噢噢 </p>
          ...
          <div style="text-align: right;">
            <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;">
              <!-- <a href="pInfoDescription.html" style="color: white; "></a> -->
              查看</button>
          </div>
...
<!-- 第儿个框结束 -->
 ...
 <li class="col-md-6" style="float: left;">
  <div class="box box-default">
    ...
    <div style="text-align: right;">
      <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;"><a href="pInfoDescription.html" style="color: white; ">查看</a></button>
    </div>
