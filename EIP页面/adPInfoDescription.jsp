            ...
            <ul class="miaoShu">
                ...
                <div class="form-group col-xs-12 ">
                  <button type="button" class="btn btn-danger col-xs-offset-1" style="margin-top: 30px;" data-toggle="modal" data-target="#myModal-del">删除</button>
                    ...
                    <button type="button" class="btn btn-warning col-xs-offset-1" style="margin-top: 30px; margin-left: 30px;">
                      <!-- <a href="adPInfoDesChange.html"></a> -->
                      修改</button>
                  
                    <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 30px;margin-left: 30px;">
              ...
              <div class="modal-header">
                  ...
                  <div style="width: 100%;text-align: right;">
                      ...
                      <button type="submit" class="btn btn-primary" style="margin-right: 14px;">
                          <!-- <a href="adPInfo.html" style="color: white"></a> -->
                      确定</button>
                  </div>
              </div>
          </div>
