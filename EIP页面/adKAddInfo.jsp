        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="adKInfo.html"><i class="fa fa-circle-o"></i> 幼稚园</a></li>
          ...
          <div class="row" >
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title" href="infoDescription.html">幼稚园</h3>
              </div>
              <div class="box-body">
                <div class="box-body " id="inputchoose" >
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">幼稚园名称</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">幼稚园描述</label>
                        <div class="col-sm-5">
