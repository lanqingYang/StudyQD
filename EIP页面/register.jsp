        ...
        <div class="col-md-offset-3 col-md-6" style="margin-top: 30px;">
          ...
          >
            <div class="form-group">
              <label for="sname" class="col-sm-2 control-label">用户名</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label for="sage" class="col-sm-2 control-label">邮箱</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label for="smajor" class="col-sm-2 control-label">电话</label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label for="spwd" class="col-sm-2 control-label">角色选择</label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control">
                  <option selected>您父亲的名字是？</option>
                  <option>您母亲的名字是？</option>
                  <option>您宠物的名字是？</option>
                </select>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" hidden>
              <!-- 角色是否被确定 -->
              <label for="spwd" class="col-sm-2 control-label"></label>
              <div class="col-sm-10">
                <input
                  type="text"
                  class="form-control"
