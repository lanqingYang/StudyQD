          ...
          <div class="box">
            ...
            <div class="box-body " id="inputchoose" >
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="inputPassword" class="col-sm-2 control-label">密保问题</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword" class="col-sm-2 control-label">密保答案</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                  </div>
                </div>
                ...
                <div class="form-group" hidden>
                  <label for="inputPassword" class="col-sm-2 control-label">是否被禁用</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                  </div>
                </div>
                <div class="form-group" hidden>
                  <label for="inputPassword" class="col-sm-2 control-label">角色是否被确定</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="inputPassword" placeholder="Password" >
                  </div>
                </div>
