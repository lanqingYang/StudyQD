        ...
        <div class="col-md-offset-3 col-md-6" style="margin-top: 80px;">
          <form class="form-horizontal" id="dataForm">
            ...
            <div class="form-group">
              ...
              <label class="radio-inline radio-primary">
                <input type="radio" name="character" value="manager" /><span
                  >管理员</span
                >
              </label>
            </div>
            ...
            <div class="form-group">
              ...
              <a
                href="${pageContext.request.contextPath}/findPwd.jsp"
                style="
                  font-size: 1.1em;
                  margin-left: 180px;
                  display: inline-block;
        ...
        success: function (result) {
          if (result == "failure") {
            ...
            window.location.href =
              "${pageContext.request.contextPath}/to/userMain";
          } else if (result == "managerSuccess") {
            window.location.href =
              "${pageContext.request.contextPath}/to/adMain";
          }
        },
      });
    });
