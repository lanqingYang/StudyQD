            ...
            <li class="active treeview menu-open">
              <a href="#">
               ...
               <ul class="treeview-menu ">
                <li class="active"><a href="kInfo.html"><i class="fa fa-circle-o"></i> 幼稚园</a></li>
      ...
      <div class="row" >
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <a class="box-title" href="kInfoDescription.html">
              花花幼儿园</a>
          </div>
          <div class="box-body">
            <p>一段描述噢噢噢噢噢噢噢 </p>
          ...
          <div style="text-align: right;">
            <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;"><a href="kInfoDescription.html" style="color: white; ">查看</a></button>
          </div>
  ...
  <div class="box box-default">
    ...
    <div style="text-align: right;">
      <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;">
        <!-- <a href="kInfoDescription.html" style="color: white; "></a> -->
        查看</button>
    </div>
