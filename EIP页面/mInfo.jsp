            ...
            <li class=" active treeview">
              <a href="#">
               ...
               <ul class=" treeview-menu menu-open">
                ...
                <li class="active"><a href="mInfo.html"><i class="fa fa-circle-o"></i> 初&nbsp;&nbsp;中</a></li>
      ...
      <div class="row" >
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <a class="box-title" href="mInfoDescription.html">
              花花初中</a>
          </div>
          <div class="box-body">
            <p>一段描述噢噢噢噢噢噢噢 </p>
          ...
          <div style="text-align: right;">
            <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;">
              <!-- <a href="mInfoDescription.html" style="color: white; "></a> -->
              查看</button>
          </div>
...
<!-- 第一个框结束 -->
 ...
 <li class="col-md-6" style="float: left;">
  <div class="box box-default">
    <div class="box-header with-border">
      <a class="box-title" href="mInfoDescription.html">花花幼儿园</a>
    </div>
    <div class="box-body">
      <p>一段描述噢噢噢噢噢噢噢 </p>
    </div>
    <div style="text-align: right;">
      <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;"><a href="mInfoDescription.html" style="color: white; ">查看</a></button>
    </div>
