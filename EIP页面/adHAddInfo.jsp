          ...
          <div class="row" >
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title" href="infoDescription.html">高中</h3>
              </div>
              <div class="box-body">
                <div class="box-body " id="inputchoose" >
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">高中名称</label>
                        <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">高中描述</label>
                        <div class="col-sm-5">
